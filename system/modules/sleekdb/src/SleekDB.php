<?php
  ...
  require_once 'system/modules/sleekdb/traits/helpers.php';
  require_once 'system/modules/sleekdb/traits/conditions.php';
  require_once 'system/modules/sleekdb/traits/caching.php';
