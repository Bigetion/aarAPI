...
class Crypt
{
    ...
    public function acm_coordinat($var_p = 234, $var_q = 567, $var_l = 10, $is_encrypt = true)
    {
    ...
    public function acm_rand_encrypt($str, $key, $p = 8279, $q = 6371)
    {
        $str = str_pad($str, 10, " ");
    ...
    public function acm_rand_decrypt($str, $key, $p = 8279, $q = 6371)
    {
